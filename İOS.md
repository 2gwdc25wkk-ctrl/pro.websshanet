...
WebSHA is an awesome SSH / SFTP / Port Forwarding client for macOS, iOS and iPadOS 🎉

* :mega: This repository should be used to [report any issue](https://github.com/isontheline/pro.webssh.net/issues) with the use of [WebSHA](https://apps.apple.com/us/app/webssh-pro/id497714887) application.
